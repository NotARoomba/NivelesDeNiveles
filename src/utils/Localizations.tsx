...
export const Localizations = new LocalizedStrings({
    "es": {
        ...
        NO_CONNECTION: 'Hubo un error al conectarse al servidor, verifique su conexión a Internet.',
        loginButton: 'Entrar',
    ...
    "en": {
        ...
        NO_CONNECTION: 'There was an error connecting to the server, please check your internet connection.',
        loginButton: 'Enter',
    ...
    "fr": {
        ...
        NO_CONNECTION: "Une erreur s'est produite lors de la connexion au serveur, veuillez vérifier votre connexion Internet.",
        loginButton: 'Entrer',
