...
export default function PersonCard({name, role, image, github, insta, linkedin, delay}: PersonCardProps) {
    return <motion.div initial={{opacity: 0, y: 75}}
    whileInView={{opacity: 1, y: 0, transition: {duration: 1, delay, ease: 'easeInOut'}}} ><div className="w-full h-auto aspect-square rounded-xl justify-center mx-auto relative group z-20 overflow-hidden">
    ...
    <a href={github} className='h-12 font-bold text-xl  z-30  transition-all duration-500 rounded-full justify-center'>
        <i className={'bx bx-md text-dark bxl-github justify-center my-1.5'} />
      </a>
      {linkedin && <a href={linkedin} className=' h-12 font-bold text-xl  z-30  transition-all duration-500 rounded-full justify-center'>
        <i className={'bx bx-md text-dark bxl-linkedin justify-center  my-1.5'} />
      </a>}<a href={insta} className=' h-12 font-bold text-xl  z-30  transition-all duration-500 rounded-full justify-center'>
        <i className={'bx bx-md text-dark bxl-instagram justify-center  my-1.5'} />
      </a>
    </div>
     </motion.div>
}