...
export default function AdvancementCard({
  ...
  return (
    ...
    whileInView={{opacity: 1, y: 0, transition: {duration: 0.75, delay: .25}}}  className="w-2/5 h-auto rounded-xl justify-center mx-auto relative group z-20 overflow-hidden">
      ...
      <a href={link} className='absolute bottom-1/2 w-12 h-12 translate-y-1/2 font-bold text-xl bg-light left-1/2 -translate-x-1/2  z-30 opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-full justify-center'>
